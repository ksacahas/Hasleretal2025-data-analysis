...
def find_angles(tg_binary, skeleton, contour, pix, ns, nc):
    ...
    # if pix is in contour and skeleton
    if skeleton[pix[0], pix[1]] > 0 and contour[pix[0], pix[1]] > 0:
        print("pix in contour AND skeleton")
        ...
        print("first and second neighbors: ", ns_s_n)
    ...
    elif skeleton[pix[0], pix[1]] > 0 and contour[pix[0], pix[1]] == 0:
    ...
    # if pix is in contour
        ...
        print("first and second neighbors: ", nc_c_n)
        # calculate slope and angle
    ...
    # if pix is neither in skeleton nor in contour
        ...
        ns_s_n = (ns, *[n for n in ns_neighbors if any(np.array_equal(n, r) for r in skeleton_list)])
        ns_s_n = ns_s_n[:5]
        print("first and second skeleton neighbors: ", ns_s_n)
        ...
        nc_c_n = nc_c_n[:5]
        print("first and second contour neighbors: ", nc_c_n)
