...
def find_closest_points(center, all_neighbors, contour, skeleton):
    ...
    if contour[center[0], center[1]] > 0 and skeleton[center[0], center[1]] == 0:
        return None, center, [0,0]

    elif skeleton[center[0], center[1]] > 0 and contour[center[0], center[1]] == 0:
        return center, None, [0,0]

    elif contour[center[0], center[1]] > 0 and skeleton[center[0], center[1]] > 0:
